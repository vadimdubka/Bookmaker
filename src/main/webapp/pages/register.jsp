...
<main>
    <div class="layout-positioner">
        <section class="block-float border-test">
            <div class="block-header"><h2><fmt:message key="register.header"/></h2></div>
            <div class="block-content">
                ...
                <form class="register-form clearfix" name="registerForm" action="controller" method="post">
                    ...
                    <div class="input-block">
                        <label for="18-years-checkbox">Мне уже есть 18 лет</label>
                        <input id="18-years-checkbox" type="checkbox" name="18-years" required/><br/>
                    </div>
                    <div class="input-block">
