...
CREATE TABLE IF NOT EXISTS `bookmaker`.`event` (
  ...
  `result1` VARCHAR NULL DEFAULT NULL COMMENT 'Результат первого участника.',
  `result2` VARCHAR NULL DEFAULT NULL COMMENT 'Результат второго участника.',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `bookmaker`.`bet` (
  ...
  `coefficient` DECIMAL(5,2) NOT NULL COMMENT 'Коэффициент доходности на момент ставки игрока.',
